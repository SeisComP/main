...
MainFrame::MainFrame(){
	...
	*/
	...
	connect(SCApp, SIGNAL(messageAvailable(Seiscomp::Core::Message*, Seiscomp::Client::Packet*)),
	        _eventList, SLOT(messageAvailable(Seiscomp::Core::Message*, Seiscomp::Client::Packet*)));
...
*/
	...
	string user = System::HostInfo().login();
	string host = System::HostInfo().name();
	int pid = System::HostInfo().pid();
...
void MainFrame::messageAvailable(Seiscomp::Core::Message *msg, Seiscomp::Client::Packet*) {
